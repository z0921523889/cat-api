...
// 2019-07-09 14:10:01.0631412 +0800 CST m=+1.041221301
...
var doc = `{
    ...
    "paths": {
        ...
        "/api/v1/cats": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "貓列表的狀態(系統代售中 : 1 / 待售中 : 2/預約中 : 3 /確認交易 :4 / 待交貨 : 5 /收養中 : 6)",
                        "name": "status",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/cats/{catId}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "貓的狀態(系統代售中 : 1 / 待售中 : 2/預約中 : 3 /確認交易 :4 / 待交貨 : 5 /收養中 : 6)",
                        "name": "status",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/api/v1/thumbnails/{thumbnailId}/cats/{catId}": {
            "post": {
